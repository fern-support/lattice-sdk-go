...
type Allocation struct {
	...
	ActiveAgents []*common.Agent `json:"activeAgents,omitempty" url:"activeAgents,omitempty"`
...
func (a *Allocation) GetActiveAgents() []*common.Agent {
	if a == nil {
		return nil
	}
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (a *Allocation) SetActiveAgents(activeAgents []*common.Agent) {
...
func (p *Principal) GetTeam() *task.Team {
	if p == nil {
		return nil
	}
	return p.Team
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (p *Principal) SetTeam(team *task.Team) {
	p.Team = team
