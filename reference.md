...
## Entity OAuth2
<details><summary><code>client.Entity.OAuth2.GetToken(request) -> *entity.GetTokenResponse</code></summary>
<dl>
<dd>
...
## Entities
<details><summary><code>client.Entity.Entities.PublishEntity(request) -> *entity.Entity</code></summary>
<dl>
<dd>
...
client.Entity.Entities.PublishEntity(
        context.TODO(),
        request,
    )
}
...
<details><summary><code>client.Entity.Entities.GetEntity(EntityID) -> *entity.Entity</code></summary>
<dl>
<dd>
...
client.Entity.Entities.GetEntity(
        context.TODO(),
        request,
    )
}
...
<details><summary><code>client.Entity.Entities.OverrideEntity(EntityID, FieldPath, request) -> *entity.Entity</code></summary>
<dl>
<dd>
...
client.Entity.Entities.OverrideEntity(
        context.TODO(),
        request,
    )
}
...
**provenance:** `*entity.Provenance` — Additional information about the source of the override.
...
<details><summary><code>client.Entity.Entities.RemoveEntityOverride(EntityID, FieldPath) -> *entity.Entity</code></summary>
<dl>
<dd>
...
client.Entity.Entities.RemoveEntityOverride(
        context.TODO(),
        request,
    )
}
...
<details><summary><code>client.Entity.Entities.LongPollEntityEvents(request) -> *entity.EntityEventResponse</code></summary>
<dl>
<dd>
...
client.Entity.Entities.LongPollEntityEvents(
        context.TODO(),
        request,
    )
}
...
<details><summary><code>client.Entity.Entities.StreamEntities(request) -> entity.StreamEntitiesResponse</code></summary>
<dl>
<dd>
...
client.Entity.Entities.StreamEntities(
        context.TODO(),
        request,
    )
}
...
## Tasks
<details><summary><code>client.Task.Tasks.CreateTask(request) -> *task.Task</code></summary>
<dl>
<dd>
...
**specification:** `*task.GoogleProtobufAny` — The path for the Protobuf task definition, and the complete task data.
...
**initialEntities:** `[]*task.TaskEntity` 
...
<details><summary><code>client.Task.Tasks.GetTask(TaskID) -> *task.Task</code></summary>
<dl>
<dd>
...
<details><summary><code>client.Task.Tasks.UpdateTaskStatus(TaskID, request) -> *task.Task</code></summary>
<dl>
<dd>
...
client.Task.Tasks.UpdateTaskStatus(
        context.TODO(),
        request,
    )
}
...
**newStatus:** `*task.TaskStatus` — The new status of the task.
...
<details><summary><code>client.Task.Tasks.QueryTasks(request) -> *task.TaskQueryResults</code></summary>
<dl>
<dd>
...
**statusFilter:** `*task.TaskQueryStatusFilter` 
...
**updateTimeRange:** `*task.TaskQueryUpdateTimeRange` — If provided, only provides Tasks updated within the time range.
...
<details><summary><code>client.Task.Tasks.ListenAsAgent(request) -> *task.AgentRequest</code></summary>
<dl>
<dd>
...
client.Task.Tasks.ListenAsAgent(
        context.TODO(),
        request,
    )
}
...
**agentSelector:** `*task.EntityIDsSelector` — Selector criteria to determine which Agent Tasks the agent receives
