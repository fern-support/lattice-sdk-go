...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Name", "github.com/fern-support/lattice-sdk-go/v4")
	headers.Set("X-Fern-SDK-Version", "v4.999.999")
	headers.Set("User-Agent", "github.com/fern-support/lattice-sdk-go/4.999.999")
	return headers
}
