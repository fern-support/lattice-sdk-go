...
import (
	json "encoding/json"
	fmt "fmt"
	task "github.com/anduril/lattice-sdk-go/v4/common/task"
...
type GroupDetails struct {
	Team    *task.Team `json:"team,omitempty" url:"team,omitempty"`
...
func (g *GroupDetails) GetTeam() *task.Team {
	if g == nil {
		return nil
	}
	return g.Team
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (g *GroupDetails) SetTeam(team *task.Team) {
	g.Team = team
