...
func TestEntityOAuth2GetTokenWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Entity.OAuth2.GetToken(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestEntityOAuth2GetTokenWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestEntityOAuth2GetTokenWithWireMock", "POST", "/api/v1/oauth/token", nil, 1)
}
